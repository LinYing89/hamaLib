...
import com.bairock.iot.hamalib.device.remoter.RemoterContainer.OnRemoterOrderSuccessListener;
...
public class RemoterContainerTest {
	...
	public void setUp() throws Exception {
		rc = (RemoterContainer) DeviceAssistent.createDeviceByMc(MainCodeHelper.YAO_KONG, "0001");
		
		String mcId = MainCodeHelper.SMC_REMOTER_DIAN_SHI;
		Remoter rTv = (Remoter) DeviceAssistent.createDeviceByMc(mcId, "1");
		...
		String mcId3 = MainCodeHelper.SMC_REMOTER_CHUANG_LIAN;
		Remoter rCoutain = (Remoter) DeviceAssistent.createDeviceByMc(mcId3, "1");
		...
		String mcId2 = MainCodeHelper.SMC_REMOTER_KONG_TIAO;
		Remoter rAir = (Remoter) DeviceAssistent.createDeviceByMc(mcId2, "1");
