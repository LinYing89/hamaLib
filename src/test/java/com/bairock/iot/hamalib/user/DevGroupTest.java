...
public class DevGroupTest {
	...
	public void testGetDeviceWithCoding() {
		Device dev = DeviceAssistent.createDeviceByMc(MainCodeHelper.XIE_TIAO_QI, "0001");
		...
		devS.getListDev().get(0).setMainCode(MainCodeHelper.SMC_DENG);
		...
		devSwitch.getListDev().get(1).setMainCode(MainCodeHelper.SMC_DENG);
