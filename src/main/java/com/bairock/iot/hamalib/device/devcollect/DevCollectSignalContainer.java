...
import com.bairock.iot.hamalib.device.DevContainer;
...
import com.bairock.iot.hamalib.device.XRoadDevice;
...
public class DevCollectSignalContainer extends DevContainer implements XRoadDevice{
	...
	protected void initChildDevices() {
		for (int i = 1; i <= 16; i++) {
			DevCollectSignal sd = (DevCollectSignal) DeviceAssistent.createDeviceByMc(MainCodeHelper.COLLECTOR_SIGNAL,
					String.valueOf(i));
