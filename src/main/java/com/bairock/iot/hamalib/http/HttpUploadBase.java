package com.bairock.iot.hamalib.http;
...
public class HttpUploadBase extends Thread{

    private String strUrl;
    private Object uploadObject;
    private OnExecutedListener onExecutedListener;
    
    public HttpUploadBase(String strUrl, Object uploadObject) {
        this.strUrl = strUrl;
...
//          urlConnection.setRequestProperty("Accept-Language", "zh-CN");
            ...
            String jsonUser = mapperWrite.writeValueAsString(uploadObject);
